...
using static ImageGeneration.DiffusionViewModel;
using Object = Java.Lang.Object;
using Random = Java.Util.Random;

namespace ImageGeneration;

[Activity(Name = "com.google.mediapipe.examples.imagegeneration.diffusion.DiffusionActivity", Label = "@string/app_name", Theme = "@style/AppTheme")]
public class DiffusionActivity : AppCompatActivity,
    ...
    IContinuation
{
    ...
    private DiffusionViewModel viewModel = new();
    ...
    override protected void OnCreate(Bundle savedInstanceState)
    {
        ...
        SetContentView(Resource.Layout.activity_diffusion);
    ...
    {
        DiffusionViewModel viewModel;
        int id;
        public TextWatcher(DiffusionViewModel viewModel, int id)
        {
    ...
    private void ShowError(string message)
    {
        ...
        RunOnUiThread(() =>
        {
            ...
            Log.Error("DiffusionActivity", "ImgGen Error" + message);
        });
