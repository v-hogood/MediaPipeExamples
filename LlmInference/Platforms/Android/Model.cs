...
public class Model
{
    Model(string name, string path, string url, string licenseUrl, bool needsAuth, Backend preferredBackend, bool thinking, float temperature, int topK, float topP)
    {
        Name = name;
        Path = path;
        Url = url;
